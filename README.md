This project represents a C# implementation of the Trompf card game. The application simulates a complete match with 4 players divided into 2 teams, played over 6 rounds.
